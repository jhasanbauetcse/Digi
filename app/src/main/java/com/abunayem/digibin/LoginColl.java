        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        startActivity(new Intent(LoginColl.this, MainActivity.class));
                        finish();
                    } else {
                        Toast.makeText(LoginColl.this, "Authentication failed. Please try again.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
